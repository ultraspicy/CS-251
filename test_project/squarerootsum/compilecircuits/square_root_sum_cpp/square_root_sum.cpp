...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 54
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 58
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 65
while(Fr_isTrue(&expaux[0])){
{
